...
const EditCrate = ({ panel, editModalVisible, setEditModalVisible, fetchPanels }) => {
    ...
    const onFinish = async (values) => {
        try {
            ...
            const response = await api.request('put', `/api/crate/${panel._id}`, values);
            setEditModalVisible(false);
            fetchPanels();
        } catch (error) {
            console.error('Error editing Crates:', error);
        }
    };
